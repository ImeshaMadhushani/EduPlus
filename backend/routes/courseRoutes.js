...
import { createCourse, deleteCourse, enrolledCourse, getAllCourses, getCourseById, updateCourse } from '../controllers/courseController.js';
...
router.get('/enrolledCourse', enrolledCourse);
